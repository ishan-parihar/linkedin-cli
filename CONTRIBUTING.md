...
Contributions are welcome! Please [open an issue](https://github.com/ishan-parihar/linkedin-lyr/issues) first to discuss the feature or bug fix before submitting a PR.
...
1. [Open an issue](https://github.com/ishan-parihar/linkedin-lyr/issues) using the correct GitHub issue template. Fill in every section; delete optional sections if not applicable.
